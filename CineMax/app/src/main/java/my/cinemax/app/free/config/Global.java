...
public class Global {
    ...
    // public static final String ITEM_PURCHASE_CODE = "d506abfd-9fe2-4b71-b979-feff21bcad13"; // Subscription removed
    // public static final String SUBSCRIPTION_ID = "my.cinemax.app.free.subs"; // Subscription removed
